...
"""
    ...
    help_text = "**(font){}现有指令(font)[success]**\n".format(bot_name) + help_text

    res = [{"type": "section",
            "text": {"type": "kmarkdown", "content": help_text}, }]
    cards = [{"type": "card", "theme": "success", "size": "lg", "modules": res}]
    res_text = MessageSegment.Card(cards)
